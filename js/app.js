...
var CELULAR_EMPRESA = '5554996587327';
...
cardapio.metodos = {
  ...
  obterItensCardapio: (categoria = 'burgers', vermais = false) => {
    ...
    $.each(filtro, (i, e) => {
      ...
      // botão ver mais foi clicando (12 itens)
      if (vermais && i >= 8 && i < 12) {
  ...
  // altera os textos e exibe os botoes das etapa
  carregarEtapa: (etapa) => {
...
cardapio.templates = {
  ...
  item: `
  <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated fadeInUp" id="\${id}">
